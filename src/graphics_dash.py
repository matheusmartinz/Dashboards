...
#                 legend= dict(orientation = 'h', x=0.1, y=1.13 , xanchor='left', yanchor='top'),
#                 font = dict(family = 'Arial', size = 14.5, color = 'black' ),
#                 paper_bgcolor = '#FEFAE0',
...
# def gerar_graficos(DF, cores_graficos):
    


#     # Gráficos Plotly
#     graph_bar = px.bar(
#         DF_grouped, x='Data', y='Valor Final', color='Produto',
...
#     graph_pie = px.pie(
#         DF, names='Região Lojas', values='Valor Final', color='Região Lojas',
#         color_discrete_sequence=cores_graficos
#     )
#     updateLayout(graph_pie, 'pie')
...
#     graph_line = px.line(
#         DF_line, x='Data', y='Valor Unitário', color='Região Lojas', markers=True,
#         color_discrete_sequence=cores_graficos
#     )
#     updateLayout(graph_line, 'line')

#     graph_histogram = px.histogram(
#         DF, x='Produto', y='Valor Final', color='Produto',
#         color_discrete_sequence=cores_graficos
#     )
#     updateLayout(graph_histogram, 'histogram')
